...
import '../screens/Register/notification_service.dart'; // Add this import
...
class _RegisterScreenState extends State<RegisterScreen> {
          ...
          child: Form(
            ...
            child: ListView(children: [
              ...
              ButtonComponent(
                    () {
                  register();
                  // Schedule a reminder for the registration
                  scheduleReminder();
                },
                buttonName: 'Register',
              ),
  ...
  void scheduleReminder() {
    ...
    final reminderTime = now.add(Duration(minutes: 1)); // Set reminder for 1 minute after registration
